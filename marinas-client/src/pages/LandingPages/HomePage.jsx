...
const HomePage = () => {
  return (
    <div className="flex w-full flex-col gap-6">
      ...
      <section className="border-y-2 border-gray-400 bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="mb-6">
      ...
      <section className="border-y-2 border-gray-400 bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <article className="rounded-3xl border-2 border-zinc-300 bg-zinc-100 p-4">
            <div className="flex overflow-hidden aspect-4/3 items-center justify-center rounded-[1.25rem] bg-zinc-200">
              <img src="../images/lanyard.jpg" alt="shirt" />
            </div>
          ...
          <article className="rounded-3xl border-2 border-zinc-300 bg-zinc-100 p-4">
            <div className="flex overflow-hidden aspect-4/3 items-center justify-center rounded-[1.25rem] bg-zinc-200">
              <img src="../images/sticker.jpg" alt="shirt" />
            </div>
            <h3 className="mt-4 text-lg font-semibold text-zinc-900">
              Study Supplies
            </h3>
          ...
          <article className="rounded-3xl border-2 border-zinc-300 bg-zinc-100 p-4">
            <div className="flex overflow-hidden aspect-4/3 items-center justify-center rounded-[1.25rem] bg-zinc-200">
              <img src="../images/v1.jpg" alt="shirt" />
            </div>
            <h3 className="mt-4 text-lg font-semibold text-zinc-900">
              Campus Apparel
            </h3>
            ...
            <Button to="/products" variant="secondary" className="mt-4">
              View Apparel
            </Button>
          </article>
        </div>
